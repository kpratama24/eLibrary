...
<div class="w3-brown">
	<ul class="container w3-navbar">
		<li><a href="<?php echo "http://$_SERVER[HTTP_HOST]/elibrary/pages/general/profile.php"; ?>">Welcome <b><?php echo $_SESSION['name']; ?></b>, you are logged in as <b><?php echo $_SESSION['roleName']; ?></b></a></li>
